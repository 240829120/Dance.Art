...
namespace Dance.Art.ButtonBox
{
    ...
    public class CommandButtonSource : IResourceSource
    {
        ...
        /// 资源ID
        /// </summary>
        public string ID { get; } = ResourceDefines.CommandButton;

        /// <summary>
        /// 图标
        /// </summary>
        public string Icon { get; } = "pack://application:,,,/Dance.Art.ButtonBox;component/Themes/Resources/Icons/command_button.svg";
