...
namespace Dance.Art.Domain
{
    ...
    /// 数据源过滤器
    /// </summary>
    public class DataSourceFilter : DanceModel
    {
        // ===========================================================================
        ...
        private DataSourceFilterType type;
        /// <summary>
        /// 数据源类型
        /// </summary>
        public DataSourceFilterType Type
        {
            get { return type; }
        ...
        public string? DataSourceName
        {
            ...
            set { dataSourceName = value; this.OnPropertyChanged(); }
        }
