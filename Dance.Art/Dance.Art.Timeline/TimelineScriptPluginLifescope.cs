...
namespace Dance.Art.Timeline
{
    ...
    public class ControlGridScriptPluginLifescope : DanceObject, IDancePluginLifescope
    {
        ...
        /// 编号
        /// </summary>
        public const string ID = "[Dance.Art.Timeline]:Script";
        ...
        {
            return new ScriptPluginInfo(ID, NAME, new ScriptServiceInfo(NAME_SPACE, "TimelineScriptService", typeof(TimelineScriptService)));
        }
